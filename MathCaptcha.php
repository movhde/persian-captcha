...
class MathCaptcha implements CaptchaImage
{
  private $image;
  ...
  public function create()
  {
    ...
    $_SESSION['number1'] = $randomNumberArr1[$number1];
    $_SESSION['number2'] = $randomNumberArr2[$number2];
    $gd = new FarsiGD();
    $num1 = $gd->persianText($_SESSION['number1'], 'fa', 'normal');
    $num2 = $gd->persianText($_SESSION['number2'], 'fa', 'normal');
    $x = rand(1, 120);
    $y = rand(1, 35);
    $x2 = rand(1, 120);
    $y2 = rand(1, 35);
